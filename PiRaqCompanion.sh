...
/usr/bin/chromium-browser --noerrdialogs --disable-infobars --disable-session-crashed-bubble --force-device-scale-factor=0.28 --kiosk http://127.0.0.1:8000/tablet.html
